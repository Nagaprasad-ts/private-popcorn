...
<head>
    ...
    <style>
        /* Custom transitions and states for the 60-30-10 palette */
        .selection-card:hover { border-color: #ef4444; background-color: #fef2f2; }
        .selection-card-active { border-color: #ef4444; background-color: #fef2f2; ring: 2px; ring-color: #ef4444; }
        input:focus, select:focus { border-color: #3b82f6 !important; ring: 2px !important; ring-color: #3b82f6 !important; }
    </style>
</head>
