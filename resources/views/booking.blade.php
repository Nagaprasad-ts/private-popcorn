                        ...
                        @foreach ($theatres as $theatre)
                            <label class="relative group">
                                ...
                                <div class="pb-4 bg-[#1a1a1a] border-2 border-gray-700 rounded-xl cursor-pointer text-center transition-all peer-checked:border-gold peer-checked:bg-gray-800 hover:border-gold">
                                    <img  src="{{ $theatre->image }}" alt="{{ $theatre->name }}" class="w-full h-42 object-cover mb-3 rounded-t-lg">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            @foreach ($addons as $addon)
                                <label class="relative group">
                                    ...
                                    <div class="pb-4 bg-[#1a1a1a] border-2 border-gray-700 rounded-xl cursor-pointer text-center transition-all peer-checked:border-gold peer-checked:bg-gray-800 hover:border-gold">
                                        @if ($addon->image)
                                            <img src="{{ $addon->image }}" alt="{{ $addon->name }}" class="w-full h-64 object-cover mb-3 rounded-t-lg">
                                        @endif
