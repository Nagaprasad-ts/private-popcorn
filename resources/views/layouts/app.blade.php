...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        })(window,document,'script','dataLayer','GTM-PNDWCQXL');</script>
    ...
    >
      <div class="flex items-center">
        <a href="/" class="text-2xl font-light tracking-[0.3em] uppercase serif">
            <img src="{{ asset('images/logo1.jpg') }}" alt="Private Popcorn Logo" class="h-20 inline-block" />
        </a>
      </div>
      ...
      <div class="flex items-center space-x-10">
        ...
        >
          ...
          <a href="/#gallery" class="hover:text-gold transition-colors"
            >Gallery</a
          >
          <a href="{{ route('blogs.index') }}" class="hover:text-gold transition-colors"
            >Blogs</a
          >
        </div>
